...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AutofillInlineMenuButton: function() { return /* binding */ AutofillInlineMenuButton; }
/* harmony export */ });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../utils */ "./src/autofill/utils/index.ts");
/* harmony import */ var _utils_svg_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../utils/svg-icons */ "./src/autofill/utils/svg-icons.ts");
/* harmony import */ var _shared_autofill_inline_menu_page_element__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/autofill-inline-menu-page-element */ "./src/autofill/overlay/inline-menu/pages/shared/autofill-inline-menu-page-element.ts");
...
class AutofillInlineMenuButton extends _shared_autofill_inline_menu_page_element__WEBPACK_IMPORTED_MODULE_6__.AutofillInlineMenuPageElement {
    constructor() {
        super();
        this.authStatus = _bitwarden_common_auth_enums_authentication_status__WEBPACK_IMPORTED_MODULE_2__.AuthenticationStatus.LoggedOut;
        ...
        this.logoIconElement = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_5__.logoIcon);
        this.logoIconElement.classList.add("inline-menu-button-svg-icon", "logo-icon");
        this.logoLockedIconElement = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_5__.logoLockedIcon);
    ...
    initAutofillInlineMenuButton(_a) {
        return __awaiter(this, arguments, void 0, function* ({ authStatus, styleSheetUrl, translations, portKey, }) {
            ...
            this.buttonElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleButtonElementClick);
    ...
    updateAuthStatus(authStatus) {
        ...
        const iconElement = this.authStatus === _bitwarden_common_auth_enums_authentication_status__WEBPACK_IMPORTED_MODULE_2__.AuthenticationStatus.Unlocked
...
/***/ "./src/autofill/overlay/inline-menu/pages/button/button.scss":
/*!*******************************************************************!*\
  !*** ./src/autofill/overlay/inline-menu/pages/button/button.scss ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _autofill_inline_menu_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./autofill-inline-menu-button */ "./src/autofill/overlay/inline-menu/pages/button/autofill-inline-menu-button.ts");


// FIXME: Remove when updating file. Eslint update
// eslint-disable-next-line @typescript-eslint/no-require-imports
__webpack_require__(/*! ./button.scss */ "./src/autofill/overlay/inline-menu/pages/button/button.scss");
(function () {
    globalThis.customElements.define(_enums_autofill_overlay_enum__WEBPACK_IMPORTED_MODULE_0__.AutofillOverlayElement.Button, _autofill_inline_menu_button__WEBPACK_IMPORTED_MODULE_1__.AutofillInlineMenuButton);
})();
