...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AutofillInlineMenuContainer: function() { return /* binding */ AutofillInlineMenuContainer; }
/* harmony export */ });
...
class AutofillInlineMenuContainer {
    ...
    handleInitInlineMenuIframe(message) {
        ...
        const handleInlineMenuPageIframeLoad = () => {
            this.inlineMenuPageIframe.removeEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__.EVENTS.LOAD, handleInlineMenuPageIframeLoad);
            this.setupPortMessageListener(message);
        };
        this.inlineMenuPageIframe.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__.EVENTS.LOAD, handleInlineMenuPageIframeLoad);
...
/***/ "./src/autofill/overlay/inline-menu/pages/menu-container/menu-container.scss":
/*!***********************************************************************************!*\
  !*** ./src/autofill/overlay/inline-menu/pages/menu-container/menu-container.scss ***!
  \***********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/*!***********************************************************************************************************!*\
  ...
  \***********************************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _autofill_inline_menu_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./autofill-inline-menu-container */ "./src/autofill/overlay/inline-menu/pages/menu-container/autofill-inline-menu-container.ts");
// FIXME: Remove when updating file. Eslint update
// eslint-disable-next-line @typescript-eslint/no-require-imports
__webpack_require__(/*! ./menu-container.scss */ "./src/autofill/overlay/inline-menu/pages/menu-container/menu-container.scss");

(() => new _autofill_inline_menu_container__WEBPACK_IMPORTED_MODULE_0__.AutofillInlineMenuContainer())();
