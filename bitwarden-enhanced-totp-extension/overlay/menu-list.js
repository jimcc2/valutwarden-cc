...
/* harmony export */   AuthenticationStatus: function() { return /* binding */ AuthenticationStatus; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AutofillInlineMenuList: function() { return /* binding */ AutofillInlineMenuList; }
/* harmony export */ });
...
/* harmony import */ var _bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @bitwarden/common/autofill/constants */ "../../libs/common/src/autofill/constants/index.ts");
/* harmony import */ var _bitwarden_common_vault_enums__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @bitwarden/common/vault/enums */ "../../libs/common/src/vault/enums/index.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../utils */ "./src/autofill/utils/index.ts");
/* harmony import */ var _utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../utils/svg-icons */ "./src/autofill/utils/svg-icons.ts");
/* harmony import */ var _shared_autofill_inline_menu_page_element__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../shared/autofill-inline-menu-page-element */ "./src/autofill/overlay/inline-menu/pages/shared/autofill-inline-menu-page-element.ts");
...
class AutofillInlineMenuList extends _shared_autofill_inline_menu_page_element__WEBPACK_IMPORTED_MODULE_7__.AutofillInlineMenuPageElement {
    constructor() {
        super();
        ...
        this.handleNewLoginVaultItemAction = () => {
            ...
            if (this.showInlineMenuAccountCreation) {
                addNewCipherType = _bitwarden_common_vault_enums__WEBPACK_IMPORTED_MODULE_4__.CipherType.Login;
            }
        ...
        this.handleMouseOutEvent = () => {
            globalThis.document.removeEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.MOUSEOUT, this.handleMouseOutEvent);
        ...
        this.isFilledByLoginCipher = () => {
            return this.inlineMenuFillType === _bitwarden_common_vault_enums__WEBPACK_IMPORTED_MODULE_4__.CipherType.Login;
        };
        /**
         * Identifies if the current focused field is filled by a card cipher.
         */
        this.isFilledByCardCipher = () => {
            return this.inlineMenuFillType === _bitwarden_common_vault_enums__WEBPACK_IMPORTED_MODULE_4__.CipherType.Card;
        };
        /**
         * Identifies if the current focused field is filled by an identity cipher.
         */
        this.isFilledByIdentityCipher = () => {
            return this.inlineMenuFillType === _bitwarden_common_vault_enums__WEBPACK_IMPORTED_MODULE_4__.CipherType.Identity;
        };
        /**
    ...
    initAutofillInlineMenuList(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (authStatus !== _bitwarden_common_auth_enums_authentication_status__WEBPACK_IMPORTED_MODULE_2__.AuthenticationStatus.Unlocked) {
    ...
    buildLockedInlineMenu() {
        ...
        unlockButtonElement.prepend((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.lockIcon));
        unlockButtonElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleUnlockButtonClick);
    ...
    buildSaveLoginInlineMenu() {
        ...
        saveLoginButton.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleNewLoginVaultItemAction);
        saveLoginButton.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.KEYUP, this.handleSaveLoginInlineMenuKeyUp);
    ...
    handleShowSaveLoginInlineMenuList() {
        if (this.authStatus === _bitwarden_common_auth_enums_authentication_status__WEBPACK_IMPORTED_MODULE_2__.AuthenticationStatus.Unlocked) {
    ...
    buildPasswordGenerator(generatedPassword) {
        ...
        fillGeneratedPasswordButton.append((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.keyIcon), passwordGeneratorContent);
        fillGeneratedPasswordButton.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleFillGeneratedPasswordClick);
        fillGeneratedPasswordButton.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.KEYUP, this.handleFillGeneratedPasswordKeyUp);
        ...
        refreshGeneratedPasswordButton.appendChild((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.refreshIcon));
        refreshGeneratedPasswordButton.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleRefreshGeneratedPasswordClick);
        refreshGeneratedPasswordButton.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.KEYUP, this.handleRefreshGeneratedPasswordKeyUp);
    ...
    buildColorizedPasswordElement(password) {
        ...
        for (let i = 0; i < passwordArray.length; i++) {
            ...
            if (character.match(/\W/)) {
                ...
                ariaDescription += `${this.getTranslation(_utils__WEBPACK_IMPORTED_MODULE_5__.specialCharacterToKeyMap[character])} `;
                continue;
            }
    ...
    handleUpdateAutofillInlineMenuGeneratedPassword(message) {
        if (this.authStatus !== _bitwarden_common_auth_enums_authentication_status__WEBPACK_IMPORTED_MODULE_2__.AuthenticationStatus.Unlocked || !message.generatedPassword) {
            return;
        }
    ...
    getFilteredCiphersForTotpField(ciphers) {
        ...
        const isTotpField = this.inlineMenuFillType === _bitwarden_common_vault_enums__WEBPACK_IMPORTED_MODULE_4__.CipherType.Login &&
    ...
    updateListItems({ ciphers, showInlineMenuAccountCreation, }) {
        ...
        this.newItemButtonElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.KEYUP, this.handleNewItemButtonKeyUpEvent);
    }
    /**
    ...
    buildNewItemButton(showLogin = false) {
        ...
        this.newItemButtonElement.prepend((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.plusIcon));
        this.newItemButtonElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleNewLoginVaultItemAction);
    ...
    loadPageOfCiphers() {
        ...
        if (!this.showPasskeysLabels && this.allCiphersLoaded()) {
            this.ciphersList.removeEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.SCROLL, this.updateCiphersListOnScroll);
        }
    }
    /**
    ...
    setupCipherListScrollListeners() {
        ...
        this.ciphersList.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.SCROLL, this.updateCiphersListOnScroll, options);
        if (this.showPasskeysLabels) {
            this.ciphersList.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.SCROLL, this.useEventHandlersMemo((0,_utils__WEBPACK_IMPORTED_MODULE_5__.throttle)(this.handleThrottledOnScrollEvent, 50), _bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.UPDATE_PASSKEYS_HEADINGS_ON_SCROLL), options);
        }
    }
    /**
    ...
    buildFillCipherElement(cipher) {
        ...
        fillCipherElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleFillCipherClickEvent(cipher));
        fillCipherElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.KEYUP, this.handleFillCipherKeyUpEvent);
    ...
    buildViewCipherElement(cipher) {
        ...
        viewCipherElement.append((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.viewCipherIcon));
        viewCipherElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.CLICK, this.handleViewCipherClickEvent(cipher));
        viewCipherElement.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.KEYUP, this.handleViewCipherKeyUpEvent);
    ...
    buildCipherIconElement(cipher) {
        ...
        if (((_a = cipher.login) === null || _a === void 0 ? void 0 : _a.totpField) && ((_b = cipher.login) === null || _b === void 0 ? void 0 : _b.totp)) {
            ...
            const svgElement = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(`
    ...
    `);
        ...
        if ((_c = cipher.icon) === null || _c === void 0 ? void 0 : _c.image) {
            try {
                ...
                dummyImageElement.addEventListener("error", () => {
                    ...
                    cipherIcon.classList.add("cipher-icon");
                    cipherIcon.append((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.globeIcon));
                });
        ...
        if (cipher.icon.icon.includes("bwi-credit-card")) {
            cipherIcon.append((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.creditCardIcon));
            return cipherIcon;
        }
        if (cipher.icon.icon.includes("bwi-id-card")) {
            cipherIcon.append((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.idCardIcon));
            return cipherIcon;
        }
    ...
    buildPasskeysCipherDetailsElement(cipher, cipherDetailsElement) {
        ...
        if (cipher.name !== cipher.login.passkey.rpName) {
            ...
            if (rpNameSubtitle) {
                rpNameSubtitle.prepend((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.passkeyIcon));
        ...
        if (cipher.login.username) {
            ...
            if (usernameSubtitle) {
                if (!rpNameSubtitle) {
                    usernameSubtitle.prepend((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.passkeyIcon));
        ...
        if (passkeySubtitle) {
            if (!rpNameSubtitle) {
                passkeySubtitle.prepend((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.passkeyIcon));
    ...
    createPasskeyAuthenticatingLoader() {
        ...
        passkeyAuthenticatingLoader.appendChild((0,_utils__WEBPACK_IMPORTED_MODULE_5__.buildSvgDomElement)(_utils_svg_icons__WEBPACK_IMPORTED_MODULE_6__.spinnerIcon));
    ...
    checkInlineMenuListFocused() {
        ...
        if (this.isListHovered()) {
            globalThis.document.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_3__.EVENTS.MOUSEOUT, this.handleMouseOutEvent);
            return;
        }
        this.postMessageToParent({ command: "checkAutofillInlineMenuButtonFocused" });
    }
...
/***/ "./src/autofill/overlay/inline-menu/pages/list/list.scss":
/*!***************************************************************!*\
  !*** ./src/autofill/overlay/inline-menu/pages/list/list.scss ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AutofillInlineMenuPageElement: function() { return /* binding */ AutofillInlineMenuPageElement; }
/* harmony export */ });
...
/* harmony import */ var _enums_autofill_overlay_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../enums/autofill-overlay.enum */ "./src/autofill/enums/autofill-overlay.enum.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class AutofillInlineMenuPageElement extends HTMLElement {
    constructor() {
        ...
        this.handleDocumentKeyDownEvent = (event) => {
            ...
            event.stopPropagation();
            if (event.code === "Tab") {
                this.sendRedirectFocusOutMessage(event.shiftKey ? _enums_autofill_overlay_enum__WEBPACK_IMPORTED_MODULE_1__.RedirectFocusDirection.Previous : _enums_autofill_overlay_enum__WEBPACK_IMPORTED_MODULE_1__.RedirectFocusDirection.Next);
                return;
            }
            if (event.code === "Escape") {
                this.sendRedirectFocusOutMessage(_enums_autofill_overlay_enum__WEBPACK_IMPORTED_MODULE_1__.RedirectFocusDirection.Current);
            }
        };
    ...
    setupGlobalListeners(windowMessageHandlers) {
        ...
        globalThis.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__.EVENTS.MESSAGE, this.handleWindowMessage);
        globalThis.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__.EVENTS.BLUR, this.handleWindowBlurEvent);
        globalThis.document.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__.EVENTS.KEYDOWN, this.handleDocumentKeyDownEvent);
    }
    /**
...
/* harmony import */ var _autofill_inline_menu_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./autofill-inline-menu-list */ "./src/autofill/overlay/inline-menu/pages/list/autofill-inline-menu-list.ts");


// FIXME: Remove when updating file. Eslint update
// eslint-disable-next-line @typescript-eslint/no-require-imports
__webpack_require__(/*! ./list.scss */ "./src/autofill/overlay/inline-menu/pages/list/list.scss");
(function () {
    globalThis.customElements.define(_enums_autofill_overlay_enum__WEBPACK_IMPORTED_MODULE_0__.AutofillOverlayElement.List, _autofill_inline_menu_list__WEBPACK_IMPORTED_MODULE_1__.AutofillInlineMenuList);
})();
