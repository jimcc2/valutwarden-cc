...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @bitwarden/common/autofill/constants */ "../../libs/common/src/autofill/constants/index.ts");
/* harmony import */ var _services_autofill_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/autofill-constants */ "./src/autofill/services/autofill-constants.ts");
/* harmony import */ var _services_collect_autofill_content_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/collect-autofill-content.service */ "./src/autofill/services/collect-autofill-content.service.ts");
...
/* harmony import */ var _services_insert_autofill_content_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/insert-autofill-content.service */ "./src/autofill/services/insert-autofill-content.service.ts");
...
(function (globalContext) {
    ...
    const domElementVisibilityService = new _services_dom_element_visibility_service__WEBPACK_IMPORTED_MODULE_3__["default"]();
    const collectAutofillContentService = new _services_collect_autofill_content_service__WEBPACK_IMPORTED_MODULE_2__.CollectAutofillContentService(domElementVisibilityService, domQueryService);
    const insertAutofillContentService = new _services_insert_autofill_content_service__WEBPACK_IMPORTED_MODULE_5__["default"](domElementVisibilityService, collectAutofillContentService);
    ...
    function init() {
        ...
        globalContext.document.addEventListener(_bitwarden_common_autofill_constants__WEBPACK_IMPORTED_MODULE_0__.EVENTS.DOMCONTENTLOADED, triggerOnPageLoad);
    }
    /**
    ...
    function startAutoSubmitLoginWorkflow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0,_utils__WEBPACK_IMPORTED_MODULE_6__.sendExtensionMessage)("triggerAutoSubmitLogin", { pageDetails });
        });
    }
    /**
    ...
    function handleExtensionMessage(_a) {
        return __awaiter(this, arguments, void 0, function* ({ command, fillScript, pageDetailsUrl, }) {
    ...
    function triggerAutoSubmitOnFormlessFields(fillScript) {
        ...
        const lastFieldIsPasswordInput = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.elementIsInputElement)(currentElement) && currentElement.type === "password";
    ...
    function submitElementFoundAndClicked(element, lastFieldIsPasswordInput = false) {
        const genericSubmitElement = querySubmitButtonElement(element, "[type='submit']", (node) => (0,_utils__WEBPACK_IMPORTED_MODULE_6__.nodeIsTypeSubmitElement)(node));
        if (genericSubmitElement) {
            clickSubmitElement(genericSubmitElement, lastFieldIsPasswordInput);
            return true;
        }
        const buttonElement = querySubmitButtonElement(element, "button, [type='button']", (node) => (0,_utils__WEBPACK_IMPORTED_MODULE_6__.nodeIsButtonElement)(node));
        if (buttonElement) {
    ...
    function isLoginButton(element) {
        const keywordsSet = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.getSubmitButtonKeywordsSet)(element);
        const keywordValues = Array.from(keywordsSet).join(",");
        return _services_autofill_constants__WEBPACK_IMPORTED_MODULE_1__.SubmitLoginButtonNames.some((keyword) => keywordValues.indexOf(keyword) > -1);
    }
    /**
    ...
    function getAutofillFormElements() {
        return domQueryService.query(globalContext.document.documentElement, "form", (node) => (0,_utils__WEBPACK_IMPORTED_MODULE_6__.nodeIsFormElement)(node));
    }
    /**
    ...
    function triggerMultiStepAutoSubmitLoginComplete() {
        endUpAutoSubmitLoginWorkflow();
        void (0,_utils__WEBPACK_IMPORTED_MODULE_6__.sendExtensionMessage)("multiStepAutoSubmitLoginComplete");
    }
    /**
    ...
    function updateIsFieldCurrentlyFilling(isFieldCurrentlyFilling) {
        void (0,_utils__WEBPACK_IMPORTED_MODULE_6__.sendExtensionMessage)("updateIsFieldCurrentlyFilling", { isFieldCurrentlyFilling });
    }
})(globalThis);
