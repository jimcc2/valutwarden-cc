...
(function (windowContext) {
    if (!windowContext.bitwardenAutofillInit) {
        ...
        const domElementVisibilityService = new _services_dom_element_visibility_service__WEBPACK_IMPORTED_MODULE_2__["default"](inlineMenuContentService);
        ...
        const autofillOverlayContentService = new _services_autofill_overlay_content_service__WEBPACK_IMPORTED_MODULE_1__.AutofillOverlayContentService(domQueryService, domElementVisibilityService, inlineMenuFieldQualificationService, inlineMenuContentService);
        windowContext.bitwardenAutofillInit = new _autofill_init__WEBPACK_IMPORTED_MODULE_6__["default"](domQueryService, domElementVisibilityService, autofillOverlayContentService, inlineMenuContentService);
