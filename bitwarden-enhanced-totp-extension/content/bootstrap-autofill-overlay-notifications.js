...
/*!**************************************************************************!*\
  ...
  \**************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _overlay_notifications_content_overlay_notifications_content_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../overlay/notifications/content/overlay-notifications-content.service */ "./src/autofill/overlay/notifications/content/overlay-notifications-content.service.ts");
/* harmony import */ var _services_autofill_overlay_content_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/autofill-overlay-content.service */ "./src/autofill/services/autofill-overlay-content.service.ts");
/* harmony import */ var _services_dom_element_visibility_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/dom-element-visibility.service */ "./src/autofill/services/dom-element-visibility.service.ts");
/* harmony import */ var _services_dom_query_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/dom-query.service */ "./src/autofill/services/dom-query.service.ts");
/* harmony import */ var _services_inline_menu_field_qualification_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/inline-menu-field-qualification.service */ "./src/autofill/services/inline-menu-field-qualification.service.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils */ "./src/autofill/utils/index.ts");
/* harmony import */ var _autofill_init__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./autofill-init */ "./src/autofill/content/autofill-init.ts");
// FIXME: Update this file to be type safe and remove this and next line
// @ts-strict-ignore
...
(function (windowContext) {
    if (!windowContext.bitwardenAutofillInit) {
        const domQueryService = new _services_dom_query_service__WEBPACK_IMPORTED_MODULE_3__.DomQueryService();
        const domElementVisibilityService = new _services_dom_element_visibility_service__WEBPACK_IMPORTED_MODULE_2__["default"]();
        const inlineMenuFieldQualificationService = new _services_inline_menu_field_qualification_service__WEBPACK_IMPORTED_MODULE_4__.InlineMenuFieldQualificationService();
        const autofillOverlayContentService = new _services_autofill_overlay_content_service__WEBPACK_IMPORTED_MODULE_1__.AutofillOverlayContentService(domQueryService, domElementVisibilityService, inlineMenuFieldQualificationService);
        let overlayNotificationsContentService;
        if (globalThis.self === globalThis.top) {
            overlayNotificationsContentService = new _overlay_notifications_content_overlay_notifications_content_service__WEBPACK_IMPORTED_MODULE_0__.OverlayNotificationsContentService();
        }
        windowContext.bitwardenAutofillInit = new _autofill_init__WEBPACK_IMPORTED_MODULE_6__["default"](domQueryService, domElementVisibilityService, autofillOverlayContentService, null, overlayNotificationsContentService);
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.setupAutofillInitDisconnectAction)(windowContext);
